...
class SDM230(ModBusRTU):
    ...
    def __init__(self, logger, serial_if, serial_if_baud, serial_if_byte,
        ...
        self.input_register = {"Spannung_L1": {
            ...
            "Strom_L1_demand":
                {"port": 256, "digits": 2, "Unit": "A", "use": True},
            "Max_Strom_L1_demand":
                {"port": 1024, "digits": 2, "Unit": "A", "use": True},
            "Total_kwh":
                {"port": 256, "digits": 2, "Unit": "kWh", "use": True},
            "Total_kvarh":
                {"port": 1024, "digits": 2, "Unit": "kVArh", "use": True}
        }
...
class SDM530(ModBusRTU):
    ...
    def __init__(self, logger, serial_if, serial_if_baud, serial_if_byte,
        ...
        self.input_register = {
            ...
            "Strom_L3": {
                "port": 12, "digits": 2, "Unit": "A", "use": True},
            "Wirkleistung_L1": {
                "port": 18, "digits": 2, "Unit": "W", "use": True},
            "Wirkleistung_L2": {
                "port": 20, "digits": 2, "Unit": "W", "use": True},
            "Wirkleistung_L3": {
                "port": 22, "digits": 2, "Unit": "W", "use": True},
            #"Scheinleistung_L1": {
            #    "port": 18, "digits": 2, "Unit": "VA", "use": True},
            #"Scheinleistung_L2": {
            ...
            #"Blindleistung_L3": {
            #    "port": 30, "digits": 2, "Unit": "VAr", "use": True},
            #"Leistungsfaktor_L1": {
            #    "port": 42, "digits": 2, "Unit": "", "use": True},
            #"Leistungsfaktor_L2": {
            #    "port": 44, "digits": 2, "Unit": "", "use": True},
            #"Leistungsfaktor_L3": {
            #    "port": 46, "digits": 2, "Unit": "", "use": True},
            #"Phasenwinkel_L1": {
            #    "port": 36, "digits": 2, "Unit": "Grad", "use": True},
            #"Phasenwinkel_L2": {
